...
public class EndlessChangesMain {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        if (EndlessChangesConfig.logDirtBlock)
            LOGGER.info("DIRT BLOCK >> {}", ForgeRegistries.BLOCKS.getKey(Blocks.DIRT));

        LOGGER.info(EndlessChangesConfig.magicNumberIntroduction + EndlessChangesConfig.magicNumber);

        EndlessChangesConfig.items.forEach((item) -> LOGGER.info("ITEM >> {}", item.toString()));
    }
